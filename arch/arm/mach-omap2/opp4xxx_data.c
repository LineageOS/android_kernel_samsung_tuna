...
#define OMAP4460_VDD_MPU_OPPTURBO_UV		1190000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
    ...
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOVERCLOCK_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPOVERCLOCK, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
